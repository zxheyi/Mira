-- Schema v17; source 129f14782c58eb1377dcbcc57590ba80f401ada0
...
CREATE TABLE memory_candidates (
      ...
      created_at text not null, provenance text, acceptance_mode text,
...
CREATE TABLE research_context_recalls (
...
CREATE INDEX idx_context_payload_expiry on context_payloads(expires_at);

CREATE INDEX idx_research_context_recalls_project on research_context_recalls(project_id,created_at desc);
